...
<h3> 4. 部署 SNOVA C4 服务端到 HEROKU</h3>


	* 打开命令行难看的黑色界面，输入 cd d:  回车
...
如果bash终端出现no access to this app，就到heroku重命名apps的name
打开http://abc.herokuapp.com/
如果出现
 <img src="/image/snova.jpg" />
证明成功！真不容易啊~~~
<h3>5. 下载、配置 SNOVA C4 客户端</h3>
<img src="/image/snovahome.jpg" />
